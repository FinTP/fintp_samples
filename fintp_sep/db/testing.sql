...
*/
 ...
 -- Function: findata.test_createbatchrequest(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying)

-- DROP FUNCTION findata.test_createbatchrequest(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION findata.test_createbatchrequest(inqueuename character varying, inmsgtype character varying, ingroupkey character varying, intimekey character varying, infield1val character varying, infield2val character varying, infield3val character varying, infield4val character varying, infield5val character varying, inusername character varying)
  RETURNS void AS
$BODY$
DECLARE
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION findata.test_createbatchrequest(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying)
  OWNER TO findata;
GRANT EXECUTE ON FUNCTION findata.test_createbatchrequest(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying) TO public;
GRANT EXECUTE ON FUNCTION findata.test_createbatchrequest(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying) TO findata;
GRANT EXECUTE ON FUNCTION findata.test_createbatchrequest(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying) TO finuiuser;
