...
CREATE OR REPLACE FUNCTION backoffice.sepabortmessage(inmsgid character varying)
  RETURNS void AS
$BODY$
DECLARE
...
CREATE OR REPLACE FUNCTION backoffice.sepcommitmessage(inmsgid character varying)
  RETURNS void AS
$BODY$
DECLARE
...
CREATE OR REPLACE FUNCTION backoffice.sepdecomposexmlmessage(IN inxmlnothing character varying, IN inxmlmsg text, IN intablename character varying, IN inxmllength numeric, OUT inreturncode character varying, OUT inreturnmsg character varying)
  RETURNS record AS
$BODY$
DECLARE
...
CREATE OR REPLACE FUNCTION backoffice.sepgetmessage(OUT outretcursor refcursor)
